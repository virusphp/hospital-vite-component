<div tabindex="-1" aria-hidden="true"
    class="hidden fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 items-center md:items-center h-modal md:h-full @if($show === true) show @endif"
    ...
    <div class="relative w-full h-full max-w-2xl md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <button type="button" wire:click.prevent="closeModal()"
                ...
                data-modal-toggle="subunit-modal">
